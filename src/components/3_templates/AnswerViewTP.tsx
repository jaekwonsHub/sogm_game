...
const AnswerViewTP: React.FC<IAnswerViewTPProps> = ({ id, onClick, isCorrect }) => {
  ...
  return (
    <Box display="flex" height="100vh" flexDir="column" alignItems="center" justifyContent="center" bgColor={isCorrect === "0" ? "#003366" : "#77274C"}>
      <Box width="84%" height="100vh" maxW="720px" display="flex" flexDir="column" alignItems="center" justifyContent="flex-start">
        {
          isCorrect === "0" ?
            (<Text paddingTop="7vh" height="20vh" fontSize={["55px", "60px", "65xp", "75px"]} fontWeight={500} margin="" marginBottom="10px" color="#ffffff" >
              정답!
            </Text>
            ) :
            (<Text paddingTop="7vh" height="20vh" fontSize={["55px", "60px", "65xp", "75px"]} fontWeight={500} margin="" marginBottom="10px" color="#ffffff" >
        ...
        <Box position="relative" width="100%" height="110vw" marginTop="15px" border={isCorrect === "0" ? "5px solid #002041" : "5px solid #4A122C"} display="flex" flexDir="column" alignItems="center" bgColor="#ffffff">
          ...
          <Box width="100%" marginBottom="5vh" height="25vh" display="flex" flexDir="column" justifyContent="center" alignItems="center">
