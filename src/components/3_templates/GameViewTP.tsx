  ...
  return (
    <Box width="100%" height="97vh" display="flex" flexDir="column" alignItems="center" justifyContent="center" bgColor="#006620">
      <Box width="80%" height="100vh" maxW="720px" display="flex" flexDir="column" alignItems="center" justifyContent="flex-start" paddingTop={["35px", "35px", "60px", "60px"]}>
        ...
        <Button fontSize={[16, 20, 23, 30]} bgColor="white" border="3px solid" width="80%" height="10vh" margin="20px" onClick={onClick} display="flex" flexDir="column">
          {stage.selections[0].title.map(text => <Text margin="">{text}</Text>)}
        </Button>
        <Button fontSize={[16, 20, 23, 30]} bgColor="white" border="3px solid" width="80%" height="10vh" onClick={onClick}>{stage.selections[1].title}</Button>
      </Box>
    </Box>
  )
}
